...
const CTAHome = ({ textHoverEnter, textHoverLeave }: CTAHomeProps) => {
  return (
    <div id="contact" className="container mx-auto px-4 md:px-6 lg:px-8 py-32  text-center">
      <motion.div
      ...
      >
        ...
        <motion.a
          ...
          whileTap={{ scale: 0.95 }}
          className="bg-[#FFDF1E] text-black px-10 py-5 font-medium inline-block text-lg hover:bg-white transition-colors lowercase rounded-full"
          onMouseEnter={textHoverEnter}
          onMouseLeave={textHoverLeave}
        >
          Start Your Project
